window.onload = function () {
    // Добавляем класс "loaded_hiding" для скрытия элемента при загрузке страницы
    document.body.classList.add('loaded_hiding');

    // Задержка в 3 секунды (3000 миллисекунд) перед отображением элемента
    window.setTimeout(function () {
        // Удаляем класс "loaded_hiding" и добавляем класс "loaded" для отображения элемента
